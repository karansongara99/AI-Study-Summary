...
export default function HomePage() {
  return (
    <main className="w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-black text-white flex items-center justify-center">
      {/* Container */}
      <div className="w-full max-w-5xl px-6 md:px-10 text-center">
        ...
        <p className="text-gray-300 text-base md:text-xl lg:text-2xl mb-12 leading-relaxed max-w-3xl mx-auto">
          ...
          using a powerful <span className="text-white font-medium">local AI model</span>.
